...
describe("Test nft", async function () {
  ...
  describe("Contracts", async function () {
    ...
    it ("Get nft json", async function() {
      ...
      expect(json).to.be.equal('{"type":"Basic NFT","name":"Segmint Nft 0","description":"Piece of canvas x from 0 to 0, y from 10 to 10 pixels","preview":{"source":"https://segmint-web3.github.io/frontend/collection_logo.png","mimetype":"image/png"},"files":[{"source":"https://segmint-web3.github.io/frontend/collection_logo.png","mimetype":"image/png"}],"external_url":"https://segmint-web3.github.io/frontend/"}');
    })
